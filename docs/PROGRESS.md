...
- 현재 Phase: Phase 2 — 완료
- 현재 작업: 포인트클라우드 기초 구현, 측정과 원리 이해 확인을 마쳤다.
- 다음 한 단계: Phase 3 첫 항목인 공통 timestamp 단위와 기준 시점의 범위를 설명하고 사용자 승인을 받는다.
...
1. Phase 3 첫 항목인 timestamp 단위와 기준 시점의 범위를 설명하고 사용자 승인을 받는다.
