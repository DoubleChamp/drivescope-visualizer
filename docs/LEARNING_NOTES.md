...
### 충돌 예상 구간 강조 (2026-09-17, 이해 확인 대기)
...
Phase 5의 충돌 예상 구간 강조까지 구현했으며 확장 영역과 선분 clipping 원리의 이해 확인이 남아 있다.

- 차량 중심 경로와 확장된 보행자 영역으로 footprint 충돌을 판정할 수 있는 이유
- 현재 축 정렬 판정과 OBB·연속 충돌 판정의 차이
- 이해 확인 뒤 장면에서 보행자를 선택하는 입력과 Three.js 객체 식별 방법
