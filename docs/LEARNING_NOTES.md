...
Phase 4를 마치고 Phase 5의 보행자·차량 3D 바운딩 박스와 예상 주행 경로까지 구현했다. 다음 항목도 Phase 5에서 진행한다.

- 경로 선분과 보행자 바운딩 박스가 겹치는지 공통 좌표계에서 판정하는 방법
- 충돌 예상 구간을 원본 경로와 구분되는 시각 요소로 강조하는 방법
